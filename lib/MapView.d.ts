...
import { Address, BoundingBox, Camera, ChangeEvent, Details, EdgePadding, FitToOptions, IndoorBuildingEvent, IndoorLevelActivatedEvent, KmlMapEvent, LongPressEvent, MapPressEvent, MapStyleElement, MapType, MapTypes, PanDragEvent, PoiClickEvent, SnapshotOptions, UserLocationChangeEvent, UserTrackingMode } from './MapView.types';
...
declare class MapView extends React.Component<MapViewProps, State> {
    ...
    /** */
    setUserTrackingMode(trackingMode: UserTrackingMode): void;
